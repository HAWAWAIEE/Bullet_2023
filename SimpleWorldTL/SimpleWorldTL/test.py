...
policy_file_path = r"C:\Users\shann\Desktop\PROGRAMMiNG\Python\Past_Results\SimpleEnvTL20_16workers_4map_6000000timesteps_newsettings_Results\nn\policy.pth"
...
model_state_dict = nnKeyChanger(torch.load(pth_file_path, map_location=torch.device('cpu')))
